...
thread_init (void)
{
    ...
    /*Make the parent of initial (main) thread NULL*/
               ...
               thread_func *function, void *aux)
{
    ...
    /* Initialize child element for the current thread */
    ...
    child -> exit_status = UNDEFINED_EXIT;
...
init_thread (struct thread *t, const char *name, int priority)
{
    ...
    /* Set the newly declared parameters for init thread */
    t->exec_file = NULL;
